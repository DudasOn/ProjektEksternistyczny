...
public class LaplacianEdgeDetection extends FilterAll {
    ...
    public LaplacianEdgeDetection(BufferedImage image, int xInfo, int yInfo, int filterSize) {
    ...
    public BufferedImage filterMe() {
        ...
        return ImageUtils.convolve(this.image, this.endingPointWidth, this.startingPointWidth, this.endingPointHeight, this.startingPointHeight, convolutingMatrix);
    }
}
